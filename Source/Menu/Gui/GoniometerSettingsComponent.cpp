...
GoniometerSettingsComponent::Content::Content (SharedResources& resources,
    ...
    : sharedResources (resources),
      ...
      displaySection (resources, "gon.display", "Display", false),
      glowSection (resources, "gon.glow", "Glow", false),
      rampSection (resources, "gon.ramp", "Ramp", false)
{
...
void GoniometerSettingsComponent::Content::wireSection (SettingsSection& section)
{
