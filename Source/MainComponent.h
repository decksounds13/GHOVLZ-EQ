...
public:
    ...
    void setSpec3DMetalnessAmount (float amount01, bool notifyPrefs = true);
    float getSpec3DMetalnessAmount() const noexcept;
    void setSpec3DRimAmount (float amount01, bool notifyPrefs = true);
    float getSpec3DRimAmount() const noexcept;
    void setSpec3DLightColour (juce::Colour c, bool notifyPrefs = true);
    juce::Colour getSpec3DLightColour() const noexcept;
    void setSpec3DRimColour (juce::Colour c, bool notifyPrefs = true);
    juce::Colour getSpec3DRimColour() const noexcept;
    void setSpec3DDomeFillEnabled (bool shouldEnable, bool notifyPrefs = true);
    bool isSpec3DDomeFillEnabled() const noexcept;
    void setSpec3DDomeFillStrength (float amount01, bool notifyPrefs = true);
    float getSpec3DDomeFillStrength() const noexcept;
    void setSpec3DDomeSkyColour (juce::Colour c, bool notifyPrefs = true);
    ...
    float getSpec3DSsgiStrength() const noexcept;
    void setSpec3DSsgiRadius (float amount01, bool notifyPrefs = true);
