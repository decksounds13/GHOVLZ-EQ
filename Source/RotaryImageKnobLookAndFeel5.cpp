...
RotaryImageKnobLookAndFeel5::RotaryImageKnobLookAndFeel5()
    : frames(100), minValue(5000.0f), maxValue(20000.0f)  // Correctly formatted member initializer list
{
...
void RotaryImageKnobLookAndFeel5::drawRotarySlider(juce::Graphics& g, int x, int y, int width, int height,
