...
Eight bands. Each one can be a bell, low or high shelf, notch, band-pass, high-pass, low-pass, tilt shelf, flat tilt, or all-pass — you’re not locked into a fixed layout.
...
- 8-band parametric EQ; any filter type on any band (incl. tilt shelf, flat tilt, all-pass); slopes up to 96 dB/oct
