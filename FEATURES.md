...
Eight bands. Each one can be a bell, low or high shelf, notch, band-pass, high-pass, or low-pass — you’re not locked into a fixed layout.
...
- 8-band parametric EQ; any filter type on any band; slopes up to 96 dB/oct
