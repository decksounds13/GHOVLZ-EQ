...
| Last EQ SHA Port claimed to absorb | `c432bdf6db3b4eb7269cc3ff7af675536098db7b` |
| Last EQ SHA Port observed (any poll) | `c432bdf6db3b4eb7269cc3ff7af675536098db7b` |
| Last EQ change time (UTC) | `2026-08-12T20:27:02Z` |
| Ports completed today (date + count) | `2026-08-12: 1` |
